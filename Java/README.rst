...
LocalInventory
**************
LocalInventory is a gui-driven application which allows a user to manipulate an inventory database. Parts may be added, modified, removed, and associated with products.
