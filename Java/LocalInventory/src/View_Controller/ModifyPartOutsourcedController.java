...
public class ModifyPartOutsourcedController implements Initializable {
    ...
    public void sendPart(Part part){
        ...
        if(part instanceof OutsourcedPart)
            companyNameTxt.setText(String.valueOf(((OutsourcedPart) part).getCompanyName()));
    ...
    private void onActionSaveBtn(ActionEvent event) throws IOException {
        try{
            ...
            OutsourcedPart part = (OutsourcedPart)Inventory.lookupPart(id);
            part.setName(name);
            part.setMin(min);
            part.setMax(max);
            part.setStock(stock);
    ...
    private void onActionInhouseRadio(ActionEvent event) throws IOException {
        ...
        ModifyPartInHouseController MPIController = loader.getController();
        MPIController.sendPart(part);
